		...
		<div class="izqUsuario">
			...
			<div class="actionsUsu">
				<a href="RegistroReserva.jsp">Registrar Reserva</a> <a
					...
					href="RegistroHabitacion.jsp">Registrar Habitacion</a>
			</div>
		</div>
		...
		<div class="derAcciones">
			<div class="listados">
				<a href="ControladorReserva?accion=Listar">Listado de Reservas</a> <a
					...
					href="ControladorHabitacion?accion=Listar">Listado de Habitaciones</a>
			</div>
				...
				<table border="2" align="center">
					...
					<tbody>
						...
						<tr>
							...
							<td><%=reserva.getCliente().getNombreC()%></td>
							<td><%=reserva.getHabitacion().getID_Habitacion()%></td>
							<td><%=sdf.format(reserva.getFechaInicio())%></td>
							<td><%=sdf.format(reserva.getFechaFin())%></td>
							<td><a class="btn-eliminar"
								href="ControladorReserva?accion=Eliminar&id=<%=reserva.getID_Reserva()%>">Eliminar</a></td>
							<td><a class="btn-editar" 
								href="ControladorReserva?accion=Actualizar&id=<%=reserva.getID_Reserva()%>">Actualizar</a></td>
						</tr>
						<%
						}
						} else {
						%>
						<tr>
							<td colspan="8" align="center">No hay reservas registradas</td>
						</tr>
						<%
						}
						%>
